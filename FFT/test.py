...
from utils import create_dir, seeding, rle_encode, rle_decode, load_data
...
if __name__ == "__main__":
    ...
    for i, (x, y) in tqdm(enumerate(zip(test_x, test_y)), total=len(test_x)):
        ...
        cv2.imwrite(f"resc_CM17/{name}.png", cat_images)
