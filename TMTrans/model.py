...
class FANet(nn.Module):
    def __init__(self):
        ...
        self.e1 = EncoderBlock1(3, 32,3,1,1)
        self.e2 = EncoderBlock1(32, 64,3,1,8)
    ...
    def forward(self, x):
        inputs,glcm = x[0], x[1]
        p1, s1,glcm1 = self.e1(inputs,glcm)
        p2, s2,glcm2 = self.e2(p1,glcm1)
        p3, s3,glcm3 = self.e3(p2,glcm2)
        p4, s4,glcm4 = self.e4(p3,glcm3)
